...
import { ArrowLeft, Clock, MapPin, Truck, ShieldCheck, User } from "lucide-react";
        ...
        {loading ? (
          ...
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              {/* Left Column: Items and Customer Address */}
              <div className="lg:col-span-2 space-y-6">
                {/* Items */}
                <Card className="border border-zinc-200 bg-white rounded-3xl p-6 shadow-sm">
                  <h2 className="text-lg font-bold text-zinc-950 mb-4">Daftar Barang Belanjaan</h2>
                ...
                <Card className="border border-zinc-200 bg-white rounded-3xl p-6 shadow-sm grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <div className="text-sm text-zinc-700 font-light leading-relaxed">
                      <p className="font-semibold text-zinc-800">Nama Pembeli: {order.buyer?.username}</p>
                      <p className="font-semibold text-zinc-800 mt-2">Penerima Paket: {order.deliveryAddress?.recipientName}</p>
              ...
              <div className="lg:col-span-1 space-y-6">
                ...
                <Card className="border border-zinc-200 bg-white rounded-3xl p-6 shadow-sm space-y-4">
                  <h2 className="text-lg font-bold text-zinc-950">Rincian Transaksi</h2>
