    ...
    <ProtectedRoute allowedRole="SELLER">
      <DashboardLayout>
        ...
        <Card className="max-w-xl mx-auto border border-zinc-200 bg-white rounded-3xl shadow-sm">
          <CardHeader>
            <CardTitle className="text-xl font-bold">Tambah Produk Baru</CardTitle>
            <CardDescription className="font-light">Unggah katalog produk baru untuk dijual di toko Anda.</CardDescription>
          </CardHeader>
          <form onSubmit={handleSubmit(onSubmit)}>
            <CardContent className="space-y-4">
              <div>
                ...
                <Input
                  placeholder="Nama produk (contoh: Mouse Wireless)"
                  {...register("name")}
              ...
              <div>
                ...
                <textarea
                  placeholder="Detail spesifikasi, garansi, kelebihan produk..."
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div>
                  <label className="block text-xs font-semibold text-zinc-500 uppercase tracking-wider mb-2">Stok Awal</label>
                  <Input
                    type="number"
            ...
            <CardFooter className="flex gap-3 justify-end border-t border-zinc-100 pt-6 mt-4">
              ...
              <Button type="submit" disabled={loading} className="bg-zinc-950 hover:bg-zinc-800 text-white rounded-lg">
