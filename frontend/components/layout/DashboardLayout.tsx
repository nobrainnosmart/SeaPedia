...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex min-h-[calc(100vh-4rem)] bg-zinc-50">
      {/* Sidebar */}
      <aside className="w-64 bg-white border-r border-zinc-200 hidden md:flex flex-col justify-between py-6">
        <div>
          {/* User info */}
        ...
        {/* Footer actions */}
        <div className="px-4">
          <Button variant="outline" onClick={handleLogout} className="w-full text-zinc-600 hover:text-zinc-950 flex items-center justify-center gap-2 border-zinc-200">
